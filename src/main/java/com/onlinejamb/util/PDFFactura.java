...
public class PDFFactura {
	public static void crearFactura(Usuario usuario, Pedido pedido, ArrayList<LineaPedido> productosPedido){
		...
		try {
	        ...
	        tabla.addCell(String.valueOf(Math.round(precioTotal*100.00)/100.00) + "COP");
	        tabla.addCell("");
	        tabla.addCell("IVA(19%)");
	        tabla.addCell(String.valueOf(Math.round(precioIva*100.00)/100.00) + "COP");
	        tabla.addCell("");
	        tabla.addCell("Total");
	        tabla.addCell(String.valueOf(Math.round((precioTotal+precioIva)*100.00)/100.00) + "COP");
		    documento.add(tabla);
